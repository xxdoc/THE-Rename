...
'****************************************************************
' Name: rsform.bas
' Description:This .bas module allows you to re-size your form and all
' the controls re-size with it. I kept looking for
' code out on the internet that would do this right but I was
' never successful. So, I wrote this to eliminate the need for
' any ocx's or dll's. It resizes the SStab control which I found was
' a problem with most resizing routines (check it out
' for yourself). It also handles lines. It's also alot quicker.
' All you have to remember is two things. First, add the resize
' module (rs_form.bas), Second, Add one line of code (ResizeForm Me)
' to each form you want to re-size.
' By: Scott Whitlow
'
' Inputs:Add the rs_form.bas file to your project,
