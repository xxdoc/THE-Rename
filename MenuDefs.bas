...
Declare Function TrackPopupMenu Lib "user32" (ByVal hMenu As Long, ByVal wFlags As TPM_wFlags, ByVal x As Long, ByVal y As Long, ByVal nReserved As Long, ByVal hWnd As Long, lprc As Any) As Long                                                                                                                                                                                                                     ' lprc As RECT
...
Declare Function GetMenuItemInfo Lib "user32" Alias "GetMenuItemInfoA" (ByVal hMenu As Long, ByVal uItem As Long, ByVal fByPosition As Boolean, lpmii As MENUITEMINFO) As Boolean
Declare Function InsertMenuItem Lib "user32" Alias "InsertMenuItemA" (ByVal hMenu As Long, ByVal uItem As Long, ByVal fByPosition As Boolean, lpmii As MENUITEMINFO) As Boolean
'
...
Public Function ShowShellContextMenu(hwndOwner As Long, isfParent As IShellFolder, cPidls As Integer, pidlRel As Long, pt As POINTAPI, fPrompt As Boolean) As Boolean
  ...
  If hr >= NOERROR Then
    ...
    If hMenu Then
      ...
      If hr >= NOERROR Then
        ...
        idCmd = TrackPopupMenu(hMenu, TPM_LEFTALIGN Or TPM_RETURNCMD Or TPM_RIGHTBUTTON, pt.x, pt.y, 0, hwndOwner, 0)
